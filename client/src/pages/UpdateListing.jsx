    ...
    <main className="p-3 max-w-4xl mx-auto">
      ...
      <form onSubmit={handleSubmit} className="flex flex-col sm:flex-row gap-4">
        <div className="flex flex-col gap-4 flex-1">
          ...
          {/* Category Dropdown */}
          <select className="border p-3 rounded-lg" id="category" required onChange={handleChange}
          ...
          {/* Condition Dropdown */}
          <select className="border p-3 rounded-lg" id="condition" required onChange={handleChange}
